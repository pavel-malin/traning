// inplements very long integer type
#include "verulong.h"  // header file for verylong
...
verylong verylong::operator + (const verylong v)  // add verylong
{
	char temp[SZ];
	int j;
	...
	for (j = 0; j < maxlen; j++)  // for each postition
	{
