...
public:
	...
	void showData(void)  // display person's dat
	{
		cout << "\n		Name: " << name;
		cout << "\n		Age: " << age;
	}
	...
	static int diskCount();  // return number of persons if file
};
...
{						// in file
	...
	infile.seekg(0, ios::end);   // go to 0 bytes from end calculate number of persons
